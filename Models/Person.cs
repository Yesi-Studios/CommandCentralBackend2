...
namespace CommandCentral.Models
{
    /// <summary>
                ...
                RuleFor(x => x.Ethnicity).Must(x =>
                    {
                        ...
                        Ethnicity ethnicity = DataProvider.GetSession().Get<Ethnicity>(x.Id);
                ...
                RuleFor(x => x.ReligiousPreference).Must(x =>
                    {
                        ...
                        ReligiousPreference pref = DataProvider.GetSession().Get<ReligiousPreference>(x.Id);
                ...
                RuleFor(x => x.Designation).Must(x =>
                    {
                        ...
                        Designation designation = DataProvider.GetSession().Get<Designation>(x.Id);
                ...
                RuleFor(x => x.Division).Must((person, x) =>
                    {
                        ...
                        Division division = DataProvider.GetSession().Get<Division>(x.Id);
                ...
                RuleFor(x => x.Department).Must(x =>
                    {
                        ...
                        Department department = DataProvider.GetSession().Get<Department>(x.Id);
                ...
                RuleFor(x => x.Command).Must(x =>
                    {
                        ...
                        Command command = DataProvider.GetSession().Get<Command>(x.Id);
                ...
                RuleFor(x => x.PrimaryNEC).Must((person, x) =>
                    {
                        ...
                        NEC nec = DataProvider.GetSession().Get<NEC>(x.Id);
                ...
                RuleFor(x => x.UIC).Must(x =>
                    {
                        ...
                        UIC uic = DataProvider.GetSession().Get<UIC>(x.Id);
